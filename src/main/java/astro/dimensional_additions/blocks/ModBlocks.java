...
public class ModBlocks {
    ...
    public static Block VERDANT_SHOOT_BLOOM = register("verdant_shoot_bloom",
            VerdantShootBloomBlock::new, AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GREEN).replaceable().noCollision().breakInstantly()
                    .sounds(BlockSoundGroup.ROOTS).offset(AbstractBlock.OffsetType.XYZ).burnable().pistonBehavior(PistonBehavior.DESTROY).luminance(state -> 15));
    ...
    public static Block PURGENTA_SAPLING = register("purgenta_sapling",
            settings -> new SaplingBlock(DASaplingGenerator.PURGENTA, settings),
    ...
    public static Block ENDURTICA_LEAVES = register("endurtica_leaves",
            settings -> new UntintedParticleLeavesBlock(0.0F, TintedParticleEffect.create(ParticleTypes.TINTED_LEAVES, 15791889), settings),
    ...
    public static Block ENDURTICA_SAPLING = register("endurtica_sapling",
            settings -> new SaplingBlock(DASaplingGenerator.ENDURTICA, settings),
    ...
    public static void registerBlocks() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.NATURAL).register(entries -> {
            ...
            entries.addAfter(Blocks.TWISTING_VINES, ModBlocks.VERDANT_SHOOT);
